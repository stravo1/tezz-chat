<template>
  ...
  >
    <Tooltip :delayDuration="150" v-if="isEditing && role === 'user'">
    ...
    <Tooltip :delayDuration="150" v-if="!isEditing">
      <TooltipTrigger asChild>
        <Button
          @click="handleCopy"
          variant="ghost"
    ...
    <Tooltip :delayDuration="150" v-if="!isEditing && role !== 'user' && role !== 'data'">
      <TooltipTrigger asChild>
        <Button
          @click="handleBranch"
          variant="ghost"
    ...
    <Tooltip :delayDuration="150" v-if="!isEditing && role === 'assistant'">
      <TooltipTrigger asChild>
        <Button
          @click="handlePrint"
          variant="ghost"
